    ...
    <div className={styles.clickedCounter}>
      ...
      <div>
        <p style={{ color: 'green', marginTop: '30px' }}>
          {' '}
          То есть в случае, если значение <b>count</b> вам нужно сразу
          отображать на экране, то имеет смысл использовать для него{' '}
          <b>значение состояния</b>. Когда значение счетчика установлено с
          помощью
